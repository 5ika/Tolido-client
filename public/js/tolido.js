...
},{"os":29}],2:[function(require,module,exports){
(function (process){
/**
...
var ProjectTasks = React.createClass({
  ...
  render: function render() {
    ...
    if (tasks.length > 0) return React.createElement(
      'div',
      { className: 'tasks' },
      tasks
    );else return null;
...
var ProjectsCollection = React.createClass({
  ...
  render: function render() {
    ...
    this.props.projects.forEach(function (project) {
      items.push(React.createElement(
        'li',
        { key: project._id, id: project._id, className: 'project' },
        React.createElement(
          'div',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'span',
                { className: 'category hide animated fadeIn' },
                ' - ',
                project.category
              )
            ),
            React.createElement(
              'div',
              { className: 'description hide animated fadeIn' },
              project.description
            )
          ),
          React.createElement(
            'div',
            { className: 'col s12 m6 infos' },
            React.createElement(ProjectInfos, { project: project })
          )
        ),
        React.createElement(
          'div',
...
var Counter = React.createClass({
  ...
  render: function render() {
    var _countProjectsTasks = countProjectsTasks(this.props.projects);

    var Todo = _countProjectsTasks.Todo;
    var Important = _countProjectsTasks.Important;
    var Urgent = _countProjectsTasks.Urgent;
    var Delay = _countProjectsTasks.Delay;
...
var ProjectsUI = React.createClass({
  displayName: 'ProjectsUI',
...
module.exports = function (server) {
  ...
  api.deleteProject = function (callback) {
    ...
    if (confirm('Êtes-vous certain de vouloir supprimer le projet ?')) api.sendRequestToAPI('DELETE', '/' + idProject, null, function (response) {
      if (response.hasOwnProperty('result') && response.result === 'success') {
